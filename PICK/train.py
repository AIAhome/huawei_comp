...
# sys.path.append("/home/shenliao/workspace/ocr/model/PICK")
import model.PICK.model.pick as pick_arch_module
from model.PICK.data_utils import pick_dataset as pick_dataset_module

from model.PICK.data_utils.pick_dataset import BatchCollateFn
from model.PICK.parse_config import ConfigParser
from model.PICK.trainer import Trainer
...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default="/home/shenliao/workspace/ocr/model/PICK/config.json", type=str,
